...
export const ChurchSettingsPage: React.FC = () => {
  ...
  return (
    <Box>
      ...
      {tab === 4 && <SectionForm sectionKey="sms" title="SMS Settings" description="Configure your SMS gateway for bulk messaging (e.g. mNotify)." initial={s.sms || {}} readOnly={locked('sms')} fields={[{ name: 'enabled', label: 'Enable SMS', type: 'switch' }, { name: 'provider', label: 'Provider' }, { name: 'senderId', label: 'Sender ID' }, { name: 'apiKey', label: 'API key' }]} />}
